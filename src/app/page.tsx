    ...
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="mt-4 font-semibold text-emerald-800">
                — Aisha R., Mother of 3, United Kingdom
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <p className="text-gray-700 italic">
              ...
              <p className="mt-4 font-semibold text-emerald-800">
                — Sister Fatima, Registered Nurse, UK
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 text-center">
          ...
          <p className="text-lg text-gray-700 mb-8">
            If you’re ready to learn, sign up. No free trials — serious students only.
          </p>
          <Link
            href="/signup"
      ...
      <footer className="bg-emerald-800 text-white py-6 mt-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p>
            &copy; 2025 OnlineQuranLiteracy.com — “And We have certainly made
            the Qur’an easy for remembrance…” (54:17)
          </p>
        </div>
      </footer>
    </>
